...
public class KrampTestServiceApplication extends
    ...
    public void run(final KrampTestServiceConfiguration configuration,
        ...
        final ITunesSearchClient itunesSearchClient = new ITunesSearchClient(
                client);
        ...
        final ITunesSearchHealthCheck itunesSearchHealthCheck = new ITunesSearchHealthCheck(
                client);
        environment.healthChecks().register("itunes albumes",
                itunesSearchHealthCheck);
    }
